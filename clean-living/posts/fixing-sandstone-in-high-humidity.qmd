...
description: "Here's how we sorted out a real sandstone mess on our driveway by the coast."
date: 2026-06-17
categories: [cleaning, natural-stones, stone-sealing]
image: "../../images/galana-stones.webp"
author: "Rachel"
draft: false
toc: true
---
...
![Cracks on Our Galana](../images/peeling-stone.webp){width="60%"}
...
![Mold on Floor-Wall Joint](../images/moldy-galana.webp){width="60%"}
...
1.  **Sandstone needs to breathe**
    ...
    We learned the hard way that sandstone needs to breathe. By using a film-forming sealer, we likely trapped moisture beneath the surface, which contributed to peeling and cracking over time.
...
-   **Breathable penetrating stone sealers:** A good penetrating sealer protects the stone while still allowing moisture vapor to escape.
    ...
    Check current price and availability: [Foundation Armor SX5000 WB Clear/Matte Sealer (#ad)](https://amzn.to/4fVDlTg){target="_blank"}.
