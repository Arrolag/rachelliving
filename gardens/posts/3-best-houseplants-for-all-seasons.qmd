...
image: "../../images/snaky-moonshine.webp"
author: "Rachel"
draft: false
toc: true
---
...
1.  **Does it suit my home?**
    ...
    **Helpful Tools**
    ...
    -   If you're growing several houseplants, I'd consider getting a digital thermometer-hygrometer to monitor the temperature and humidity in your home. It can help you identify spaces that are consistently too hot, cold, dry, or humid for certain plants, making it easier to select the best plants to grow in different spaces. If you're looking for one, I'd recommend the [BALDR Indoor Thermometer Hygrometer (#ad)](https://amzn.to/3Quobdo){target="_blank"} because it's easy to read and uses a solar-assisted design that can help extend battery life.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Low</td>
      <td>Yes</td>
      <td><a href="https://amzn.to/43XdgvR" target="_blank">View on Amazon (#ad)</a>
</td>
    </tr>
    <tr>
      <td>ZZ Plant</td>
      ...
      <td>Very low</td>
      <td>No</td>
      <td><a href="https://amzn.to/442OKcD" target="_blank">View on Amazon (#ad)</a></td>
    </tr>
    <tr>
      <td>Snake Plant</td>
      <td>Dry homes</td>
      ...
      <td>Very low</td>
      <td>No</td>
      <td><a href="https://amzn.to/3QIb5t4" target="_blank">View on Amazon (#ad)</a></td>
    </tr>
  </tbody>
</table>
```
...
**Helpful Pick:** If you're dividing or repotting your spider plant, a [sturdy set of nursery pots (#ad)](https://amzn.to/3Quobdo){target="_blank"} makes the job much easier.
...
**Helpful Pick:** A [good microfiber towel (#ad)](https://amzn.to/3QQQbI5){target="_blank"} makes it easy to keep the leaves of your ZZ plant clean and glossy.

### 3. Snake Plant

::: {layout-ncol="2"}
![](../images/snakies.webp){width="60%"}

![](../images/moonshine.webp){width="60%"}
:::
...
**Helpful Pick:** A [soil moisture meter (#ad)](https://s.click.aliexpress.com/e/_c4b5IDnX){target="_blank"} takes the guesswork out of watering, especially if your home stays humid for much of the year.
